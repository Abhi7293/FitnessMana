...
<head>
    ...
    <!-- style js -->
    <link rel="stylesheet" href="{{asset('assets-frontend/js/bootstrap.min.js')}}">
    <!-- font awesome link -->
    <link rel="stylesheet" href="{{asset('assets-frontend/fonts/fontawesome/js/all.js')}}">
    <link rel="stylesheet" href="{{asset('assets-frontend/fonts/fontawesome/css/all.css')}}">
    ...
    <script src="{{asset('assets/js/main-base-jquery.js')}}" crossorigin="anonymous"></script>
	<script>
    ...
    <header class="bg-light">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light">
            	<a class="navbar-brand logo" href="<?php echo env('APP_URL')?>"><img src="{{asset('assets-frontend/images/Header-logo.png')}}" class="img-fluid"></a>
