  ...
  <section>
    ...
    <div class="workoutTopBanner">
      ...
      <img src="<?php echo e(asset('assets-frontend/image/bg2.jpg')); ?>">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-9 workout_content">
          ...
          <img src="<?php echo e(asset('')); ?>uploads/<?php echo $Meeting->MeetingImage;?>">
        ...
        <div class="col-lg-3 details">
          ...
          <div class="OrganizersImg">
          	...
          	<a href="<?php echo env('APP_URL')?>instructorProfile?i=<?php echo $Meeting->LedgerId?>">
	            ...
	            <img src="<?php echo e(asset('')); ?>uploads/<?php echo $Meeting->LoginPhoto;?>">
...
<!-- Meetings Table Body -->
  ...
  <?php /**PATH /home/experts3/nutridietplanner.in/test/FitnessMana/resources/views/frontend/class/class.blade.php ENDPATH**/ ?>